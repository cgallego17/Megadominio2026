...
urlpatterns = [
    ...
    path('dashboard/cotizaciones/<int:pk>/pdf/', dv.dashboard_quote_pdf, name='dashboard_quote_pdf'),
    ...
    path('dashboard/facturas/<int:pk>/pdf/', dv.dashboard_invoice_pdf, name='dashboard_invoice_pdf'),
    ...
    path('dashboard/cuentas-cobro/<int:pk>/pdf/', dv.dashboard_cuenta_pdf, name='dashboard_cuenta_pdf'),
    ...
    path('dashboard/configuracion-email/', dv.dashboard_email_config, name='dashboard_email_config'),
    ...
    path('mi-cuenta/cuentas-cobro/<int:pk>/pdf/', pv.panel_cuenta_pdf, name='panel_cuenta_pdf'),
